...
import heroImage from '../public/assets/images/manlaptop2_1080.jpg'
import optimizeImage from '../public/assets/images/optimize.jpg'
import changePlatformImg from '../public/assets/images/changePlatformsImg.svg'
...
export default function Home() {
  ...
  return (
    <>
      ...
      <HeroBackgroundImage image={"/assets/images/manlaptop2_1080.jpg"}>
        <HeroWrapper/>
        <HeroText>
          <H1 margin='0'>Go Beyond the Basic</H1>
          <H2 margin='0'>Building destinations, not just websites.</H2>
          <LogoImage src={logoImage}/>
          <Link href='getstarted' passHref><ButtonLink>Get Started for Free</ButtonLink></Link>
        </HeroText>
      ...
      { newSiteModal &&
        <Modal style={{maxWidth:'800px'}} animate={true} onClose={() => setNewSiteModal(false)} title={"Build from Scratch"}>
          <PopupContent>
            ...
            <ImageWrapper flex='1'>
              <Image style={{margin: '0 auto'}} src={newSiteImg}/>
            </ImageWrapper>
          </PopupContent>
      ...
      { refineModal &&
        <Modal style={{maxWidth:'800px'}} animate={true} onClose={() => setRefineModal(false)} title="Redesign or Refine">
          <PopupContent>
            ...
            <ImageWrapper flex='1'>
              <Image style={{margin: '0 auto'}} src={refineSiteImg}/>
            </ImageWrapper>
          </PopupContent>
          <ButtonGroup>
            <Link href='/getstarted' passHref><ButtonLink>Get Started</ButtonLink></Link>
      ...
      { changeModal &&
        <Modal style={{maxWidth:'800px'}} animate={true} onClose={() => setChangeModal(false)} title="Change Platforms">
          <PopupContent>
            ...
            <ImageWrapper flex='1'>
              <Image style={{margin: '0 auto'}} src={changePlatformImg}/>
            </ImageWrapper>
          </PopupContent>
          <ButtonGroup>
            <Link href='/getstarted' passHref><ButtonLink>Get Started</ButtonLink></Link>
